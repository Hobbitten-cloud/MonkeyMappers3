            ...
            <div className="card bg-black bg-gradient border-0 shadow-lg p-4 rounded-4 mb-4">
                <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    ...
                    <div className="btn-group" role="group">
                        <button className={`btn btn-sm ${filter === 'All' ? 'btn-warning fw-bold' : 'btn-dark text-white-50'}`} onClick={() => setFilter('All')}>All</button>
                        <button className={`btn btn-sm ${filter === 'Human' ? 'btn-warning fw-bold' : 'btn-dark text-white-50'}`} onClick={() => setFilter('Human')}>Human</button>
                        <button className={`btn btn-sm ${filter === 'Zombie' ? 'btn-warning fw-bold' : 'btn-dark text-white-50'}`} onClick={() => setFilter('Zombie')}>Zombie</button>
                    </div>
                </div>
            </div>
